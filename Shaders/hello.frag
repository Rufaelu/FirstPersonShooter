...
void main()
{
    ...
    vec3 nebulaColor1 = hsv2rgb(vec3(.2+.005*sin(nebula1pos.x * 100.0 + nebula1pos.y), 0.5, .25));
	vec3 nebulaColor2 = hsv2rgb(vec3(.7+.001*sin(nebula2pos.x * 60.0 + nebula2pos.y), .8, .25));
